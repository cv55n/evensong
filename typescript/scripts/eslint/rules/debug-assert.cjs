...
module.exports = createRule({
    ...
    meta: {
        ...
        messages: {
            secondArgumentDebugAssertError: `o segundo argumento para 'debug.assert' deve ser uma string literal`,
            thirdArgumentDebugAssertError: `o terceiro argumento para 'debug.assert' deve ser uma string literal ou uma função de seta`
        },
