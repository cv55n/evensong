...
if (options.built && options.lkg) {
    throw new Error("--built e --lkg são mutualmente exclusivos");
}

if (!options.bundle && !options.typecheck) {
    throw new Error("--no-typecheck não pode ser passado quando o bundling está desabilitado");
}
