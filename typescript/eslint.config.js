...
export default tseslint.config(
        ...
        rules: {
            ...
            "no-restricted-syntax": [
...

                {
                    ...
                    message: "evite usar null; em vez disso, use undefined."
                },
            ...
            // habilitado em eslint:recommended, mas não aplicável aqui
            ...
            // regras habilitadas em configurações typescript-eslint que não são aplicáveis ​​aqui
            ...
            "@typescript-eslint/no-empty-object-type": "off", // {} é um tipo totalmente útil e válido
            ...
            "@typescript-eslint/no-unused-vars": [
                ...
                {
                    // ignorar: (somente sublinhados | começando com exatamente um sublinhado)
                    argsIgnorePattern: "^(_+$|_[^_])",
                    varsIgnorePattern: "^(_+$|_[^_])"

                    // não definir um padrão de ignorar erros detectados; eles sempre podem ser removidos com segurança
                }
            ],

            "@typescript-eslint/no-inferrable-types": "off",

            // pendente https://github.com/typescript-eslint/typescript-eslint/issues/4820
...

    {
        ...
        rules: {
            // esses globais não existem fora dos arquivos cjs
