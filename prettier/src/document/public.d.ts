...
export namespace printer {
    function printDocToString(
        ...
        /**
         * essa propriedade tem um nome impróprio e tem sido
         * assim desde as mudanças em:
         * 
         * https://github.com/prettier/prettier/pull/15709
         * 
         * a região do documento indicada por `cursornodestart`
         * e `cursornodetext` às vezes será, na verdade, o que
         * está entre um par de leaf node na ast, em vez de um
         * node
         */
        cursorNodeStart?: number | undefined;

        /**
         * note que, assim como cursornodestart, este é um
         * nome impróprio e pode, na verdade, ser o texto
         * entre dois leaf nodes na ast em vez do texto de um
         * node
         */
    ...
    interface Options {
        /**
         * especifica o comprimento da linha que o printer
         * irá seguir
         * 
         * @default 80
         */
        ...
        /**
         * especifica o número de espaços por nível de recuo
         * 
         * @default 2
         */
        tabWidth: number;
        ...
        /**
         * utiliza tabs em vez de espaços para recuar as linhas
         * 
         * @default false
         */
        useTabs?: boolean;
