...
// ignora arquivos em diretórios de sistemas de controle de
// versão e em `node_modules`

const alwaysIgnoredDirectories = [
    ".git",
    ".sl",
    ".svn",
    ".hg",
...
const directoryIgnorerWithNodeModules = new DirectoryIgnorer(true);
const directoryIgnorerWithoutNodeModules = new DirectoryIgnorer(false);
