// inspirado por lintresultscache do eslint:
//
...
class FormatResultsCache {
    ...
    /**
     * @param {string} cacheFileLocation o path da localização do arquivo de cache (padrão: `node_modules/.cache/prettier/.prettier-cache`)
    ...
    constructor(cacheFileLocation, cacheStrategy) {
        ...
        try {
            ...
            //
            // se `createfromfile()` falhar, provavelmente é
            // porque o formato do arquivo de cache mudou; isso
            // aconteceu quando a v3.5.0 foi lançada
    ...
    setFormatResultsCache(filePath, options) {
        ...
        if (!fileDescriptor.notFound) {
            ...
            meta.data = {
                ...meta.data,
                hashOfOptions: getHashOfOptions(options)
            };
        }
    }
