    ...
    return {
        ...Object.fromEntries(
            Object.entries(normalized).map(([key, value]) => {
                ...
                // se a flag for uma opção de api do prettier, usar o nome da opção
                //
                // caso contrário, utilizar camelcase para facilitar a leitura
...
const { detailedOptions: detailedOptionsWithoutPlugins } = getContextOptionsWithoutPlugins();
