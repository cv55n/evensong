...
/**
 * obtém as estatísticas de um path fornecido
 * 
 * @param {string} filePath o path para o arquivo alvo
 * 
 * @returns {Promise<Stats | undefined>} as estatísticas
 */
...
/**
 * obtém estatísticas de um path fornecido sem seguir links
 * simbólicos
 * 
 * @param {string} filePath o path para o arquivo alvo
 * 
...
/**
 * substituir `\` por `/` no windows
 * 
 * @param {string} filepath
 * 
 * @returns {string}
 */
const normalizeToPosix = path.sep === "\\"
