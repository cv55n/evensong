                ...
                <div className="flex-1 bg-[#fbfbfb] pb-12 dark:bg-[#1a1a1e]">
                    <div className="relative px-6 pt-6 md:hidden">
                        <div className="fixed top-5 left-6 z-20 md:hidden">
                            <SidebarTrigger aria-label="navegação" size="icon" variant="filled" />
                        </div>

                        { /* <div className="flex- place-content-end">
                            <Link className="text-xl fond-bold" href={`/docs/packages/${packageName}/${version}`}>
                                {packageName}
                            </Link>
                        </div> */ }
                    </div>
