...
export default defineConfig(
    ...
    {
		files: [
            `packages/{api-extractor,brokers,create-discord-bot,docgen,ws}/**/*${commonFiles}`
        ],
		...
		rules: {
			...
			'no-restricted-syntax': [
                ...
                
                {
					...
					message: 'use exportações nomeadas em vez de modules.exports',
				},

				{
					selector: "VariableDeclarator[init.callee.name='require'][init.arguments.0.value=/^\\./]:not([id.type='ObjectPattern'])",
					message: 'use a desestruturação de objetos ao exigir módulos locais',
				}
			]
		}
	},
	...
	{
		files: [
            `packages/discord.js/src/client/websocket/handlers/*.js`
        ],
    ...
    {
		files: [
            `packages/discord.js/typings/*{d.ts,test-d.ts,d.mts,test-d.mts}`
        ],
    ...
    {
		files: [
            `packages/structures/**/*${commonFiles}`
        ],
